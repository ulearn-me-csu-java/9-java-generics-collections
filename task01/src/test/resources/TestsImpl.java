...
public class TestsImpl implements ITests {
    ...
    public void testEqualsOtherObjects() {
        ...
        Assertions.assertThat(pair.equals(null)).as("pair not equals null").isFalse();
        Assertions.assertThat(pair.equals("hello")).as("pair not equals String").isFalse();
    }
    ...
    public void testPrivateConstructor() {
        ...
        Assertions.assertThat(constructors).as("Pair constructors").isNotEmpty();
